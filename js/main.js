...
function displayInput() {
  if (
    ...
    screen.textContent === "a7" ||
    screen.textContent === "a" ||
    screen.textContent.indexOf("N") > -1 ||
    screen.textContent.indexOf("I") > -1
  ) {
    if (
      !(
        this.textContent === "+" ||
...
function doOperation() {
  ...
  if (
    ...
    screen.textContent.indexOf("-") > -1 ||
    screen.textContent.indexOf("x") > -1 ||
    screen.textContent.indexOf("÷") > -1
  ) {
    ...
    if (
      ...
      screen.textContent =
        Math.round(operate(operator, num1, num2) * 100) / 100;
...
displayableButtons.forEach((displayableButton) =>
  displayableButton.addEventListener("click", displayInput)
);
